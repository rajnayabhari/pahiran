...
@section('title', 'Admin Login — Pahiran')
@section('content')
<div class="max-w-md mx-auto px-4 py-16">
    <div class="text-center mb-8">
        <p class="text-stone-500 text-sm font-medium uppercase tracking-widest mb-2">Admin Portal</p>
        <h1 class="font-display text-3xl font-bold text-stone-900">Admin Login</h1>
    </div>
    ...
    <form method="POST" action="{{ route('admin.login.submit') }}" class="bg-white rounded-xl p-6 border border-stone-200 space-y-4">
        @csrf
        <div>
        ...
        <button type="submit" class="w-full bg-stone-900 text-white py-3 rounded-xl font-semibold text-sm hover:bg-stone-800 transition">Login as Admin</button>
    </form>
</div>
@endsection
